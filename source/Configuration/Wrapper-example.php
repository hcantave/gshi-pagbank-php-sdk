...
class Wrapper
{
    ...
    public const APP_ID_PRODUCTION = "your_production_application_id";
    public const APP_ID_SANDBOX = "your_sandbox_application_id";
    public const APP_KEY_PRODUCTION = "your_production_application_key";
